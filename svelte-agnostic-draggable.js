...
/**** use:draggable={options} ****/
  ...
  export function draggable (Element, Options) {
    new agnosticDraggable.Draggable(Element,Options,DraggableEventHandlers)
...
/**** use:droppable={options} ****/
  ...
  export function droppable (Element, Options) {
    new agnosticDraggable.Droppable(Element,Options,DroppableEventHandlers)
  }                    // currently, there is no possibility to update "Options"
...
/**** use:sortable={options} ****/
  ...
  export function sortable (Element, Options) {
    new agnosticDraggable.Sortable(Element,Options,SortableEventHandlers)
  }                    // currently, there is no possibility to update "Options"
